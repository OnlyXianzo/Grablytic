...
has many legitimate uses — accessibility (e.g. playback-speed adjustment),
journalism and fact-checking, preserving evidence, and downloading
Creative Commons-licensed or public-domain works, among others. This is the
same position the open-source community and the EFF defended for this category
of tooling (see the EFF's account of the 2020 youtube-dl dispute:
...
2. Identification of the allegedly infringing material in this project
   (file path, release asset, or URL).
3. Your contact information (name and an address, phone number, and/or email).
