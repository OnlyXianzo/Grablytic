...
/// `embedthumbnail` carries the user's Save-thumbnails choice and wins over
/// the engine default (True) via the config merge in `build_ydl_opts()`.
Map<String, dynamic> settingsDownloadConfig(AppSettings settings) {
  final config = <String, dynamic>{
    ...
    'embedthumbnail': settings.saveThumbnails,
